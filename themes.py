game_themes = [
    ...
    "Futuristic Cities",
    "Galactic Empires",
    "Game Creation Simulator",
    "Game Mechanics Inception",
    "Gardens of the Past",
    "Gargantuan Beasts",
    "Gaseous Worlds",
    ...
    "Horrors of the Deep",
    "Human Civilization in Reverse",
    "Hydroponic Farming",
    "Hyperspeed Adventures",
    "Ice Age Survival",
    ...
    "Island Hopping",
    "Labyrinth Builders",
    "Light Bending Adventures",
    "Lunar Colonization",
    "Machines with Souls",
    "Magical Contraptions",
    "Massive Undersea Worlds",
    "Mind Control Mysteries",
    "Miniature Worlds",
    "Mirrored Realities",
    "Monument Builders",
    "Mythical Creatures",
    ...
    "Sandbox Anomalies",
    "Seafaring Legends",
    "Shape Shifting Mysteries",
    "Snowstorm Survival",
    "Solar Systems at War",
    "Space Faring Cultures",
    "Steampunk Villains",
    "Storm Chasers",
...
the_themes = sorted(set(LudumDareThemeList + game_themes))
